...
version = "ver 3.3 written by Claude Pageau"
'''
 SimpleHTTPServer python program to allow selection of media from right panel and display in an iframe left panel
...
configFilePath = os.path.join(base_dir, "settings.py")
...
class DirectoryHandler(SimpleHTTPRequestHandler):
    ...
    def list_directory(self, path):
        ...
        if not self.path is "/":    # Display Back arrow folder navigation if not in web root
